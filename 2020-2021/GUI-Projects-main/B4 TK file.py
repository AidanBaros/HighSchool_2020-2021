...
def mainProgram():
    ...
    try:
        ...
        B1W3 = Button(text="2.  Add a bunch of numbers", bg = "Yellow",  command = addABunch, font=Desired_font)
        B1W3.grid(column = 1, row = 5)

        B1W3 = Button(text="3.  Add a few", bg = "Yellow",  command = addAFew, font=Desired_font)
        B1W3.grid(column = 1, row = 6)

        B1W3 = Button(text="4.  Return the value at an index position", bg = "Yellow",  command = indexValues, font=Desired_font)
        B1W3.grid(column = 1, row = 7)

        B1W3 = Button(text="5.  Sort list", bg = "Yellow",  command = sortList, font=Desired_font)
        B1W3.grid(column = 1, row = 8)

        B1W3 = Button(text="6.  Random Search", bg = "Yellow",  command = randomSearch, font=Desired_font)
        B1W3.grid(column = 1, row = 9)

        B1W3 = Button(text="7.  Linear Search", bg = "Yellow",  command = linearSearch, font=Desired_font)
        B1W3.grid(column = 1, row = 10)

        B1W3 = Button(text="8.  Recursive Binary Search", bg = "Yellow",  command = RBS, font=Desired_font)
        B1W3.grid(column = 1, row = 11)

        B1W3 = Button(text="9.  Iterative Binary Search", bg = "Yellow",  command = IBS, font=Desired_font)
        B1W3.grid(column = 1, row = 12)

        B1W3 = Button(text="10. Print lists", bg = "Yellow",  command = printLists, font=Desired_font)
        B1W3.grid(column = 1, row = 13)

        B1W3 = Button(text="11. Delete a number from a list", bg = "Yellow",  command = deleteListItem, font=Desired_font)
        B1W3.grid(column = 1, row = 14)

        B1W3 = Button(text="12. Clear List", bg = "Yellow",  command = clearList, font=Desired_font)
        B1W3.grid(column = 1, row = 15)
...
def clearList(myList, unique_list):
    clearWindow()
    L1W3 = Label(top, text="", font=Desired_font)
    L1W3.grid(column = 1, row = 0)
